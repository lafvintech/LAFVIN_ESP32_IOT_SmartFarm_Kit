...
B. Find the core package named **esp32 by Espressif systems**, select version **3.2.0**, and click the **install** button to install it.
...
.. image:: _static/arduino/21.esp1.png
   :width: 1000
   :align: center
...
.. note::
   - It is recommended to install the core package version **3.2.0** for this package. Using other versions may cause program or functional abnormalities
